...
function DashboardA() {
  ...
  <div className="px-2 pt-6 xl:container mt-16 ml-60">
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div>
          <div className="h-full py-6 px-4 rounded-xl border border-gray-200 bg-white">
            <h5 className="text-xl text-gray-700">Users</h5>
            <div className="my-8">
